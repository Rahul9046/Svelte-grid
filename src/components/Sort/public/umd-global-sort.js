...
(function (global, factory) {
	...
	(global = global || self, global.GlobalSortWrapper = factory());
	...
	/* src/global-sort.svelte generated by Svelte v3.12.1 */

	const file = "src/global-sort.svelte";
	...
	function create_each_block(ctx) {
		...
		const block = {
			...
			p: function update(changed, ctx) {
				...
				if ((changed.options) && option_id_value !== (option_id_value = ctx.option)) {
	...
	function instance($$self, $$props, $$invalidate) {
		...
		Object.keys($$props).forEach(key => {
			if (!writable_props.includes(key) && !key.startsWith('$$')) console.warn(`<Global_sort> was created with unknown prop '${key}'`);
		});
	...
	class Global_sort extends SvelteComponentDev {
		constructor(options) {
			super(options);
			init(this, options, instance, create_fragment, safe_not_equal, ["options"]);
			dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "Global_sort", options, id: create_fragment.name });

			const { ctx } = this.$$;
			const props = options.props || {};
			if (ctx.options === undefined && !('options' in props)) {
				console.warn("<Global_sort> was created without expected prop 'options'");
			}
		}

		get options() {
			throw new Error("<Global_sort>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
		}

		set options(value) {
			throw new Error("<Global_sort>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
		}
	}
	...
	return globalSortWrapper$1;

})));
//# sourceMappingURL=umd-global-sort.js.map
